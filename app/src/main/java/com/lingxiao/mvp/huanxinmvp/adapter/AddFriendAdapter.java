...
public class AddFriendAdapter extends RecyclerView.Adapter<AddFriendAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.textView.setText((String) avUsers.get(position).get(ContentValue.NICKNAME));
        ...
        if (contacts.contains(username)) {
            ...
            holder.addImage.setImageResource(R.drawable.ic_img_add);
            holder.addImage.setEnabled(true);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            addImage = itemView.findViewById(R.id.img_add);
        }
    }
