...
public class ChineseCharToEnUtil {
    ...
    public static String getFirstChar(String text){
        if (TextUtils.isEmpty(text)){
            ...
            String str = text.substring(0,1).toUpperCase();
    ...
    /**
     * @TODO 如果混有英文和中文的list 暂时无法排序
     * 将一个装有UserModel对象的 list 根据name 首字母排序
     * @param list 排序前的数据源
     * @return list排序后的数据
     */
    public static List<ContactsModel> listToSortByName(List<ContactsModel> list){
        try {
            if(list==null || list.size()==0){
                return null;
            }
            Map<String, ContactsModel> map = new HashMap<String, ContactsModel>();
